...
1) Miscellaneous commands (compare with :ref:`miscom_syntax`).
...
miscom.src routine (see :ref:`miscom_syntax`). We will
...
a) The READ command
   ...
   they are symmetrically placed with respect to oxygen. (NOTE that if
   ...
   will be given to the solvent. (see also :ref:`rism_theory`, section 5 ).
   ...
   was issued) to structure 2. (see also :ref:`rism_theory`, section 5 ).
   ...
   function cs(r), (see :ref:`rism_theory`, section 2) 
   ...
   solvent (VV) is assumed as a default. The keyword SOLUTE
   ...
   (for an explanation of these symbols see :ref:`rism_theory`, section 1).
   ...
   The keyword SOLUTE specifies which solute causes the solvent response.
   (for an explanation of these functions see :ref:`rism_thoery`, section 4).
...
c) The SETUp command
   ...
   transform that is a part of the iteration cycle (see :ref:`rism_theory`, Sections 2, 3  ). The FFT on a logarithmic
...
e) The STATe command
   ...
   DENSITY   defines the density of the various solvent segments.
             ...
             (see :ref:`rism_theory`, Section 1). Each 
   ...
   CDIE      defines the macroscopic dielectric constant of the 
             ...
             (see :ref:`rism_theory`, Sections 2, 3). 
...
f) The ITERate command

   This is the command that starts the iteration cycle that
   solves the RISM integral equations (see :ref:`rism_theory`
   ...
   PY        (see :ref:`rism_theory` Section 1)
   ...
   BD(R)     Store the function us(r)/KT-bridge in the auxiliary
             ...
             reconstituted. (see :ref:`rism_theory`, section 1).
...
g) The DERIvative command
   ...
   the solute density (see :ref:`rism_theory`, Section 4 and
   ref. [1]_. The syntax of the command is similar to the ITERate command.
...
h) The SOLVation command

   This command calculates the excess chemical potential of 
   solvation (see :ref:`rism_theory`, Section 4 and [2]_). 
   The keywords are:
...
i) The ANALysis command
   ...
   KEYWORD   FUNCTION
   ========= =============================================================
   VV | UV   Defines whether the vv or uv g(r) is to be printed
...
h,c and the so called "bridge function" b [3]_, to which equation the
...
with the initial guess cs(r)=0 and calculates the fourier transform of
...
For a description of the algorithm see [7]_. The advantage of
...
shown [8]_ that a simple modification of the asymptotic form for c(r)
...
and dipole denotes the dipole moment of the solvent (see also [9]_).
...
advantage of using the HNC closure is that it provides a closed form
...
energy of solvation. As has been shown in [1]_, the cavity energy
